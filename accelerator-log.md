...
```json
{
  "artifactId" : "hello-world-angular",
  "backendService" : "hello-world-spring.demos",
  "projectName" : "hello-world-angular"
}
```
## Log
```
...
┃ ┃ ┃ Debug Adding symbol backendServiceResourceName with value 'hello-world-spring.demos'
┃ ┃ ┃ Debug Adding symbol workloadResourceName with value 'hello-world-angular'
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [http://backend/api/->http://hello-world-s...(truncated)]
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [angular-frontend->hello-world-angular]
